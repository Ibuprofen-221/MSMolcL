...
from utils import standardize_parent_mol_from_smiles
...
def calc_data_from_smile(smiles, addh=False, with_ring_conj=False, with_atom_feats=True, with_submol_fp=True, radius=2, fp_nbits=256):
    '''
    ...
    for i in range(mol.GetNumAtoms()):
        ...
        if with_submol_fp:
            ...
            submolfp = subfp.gen_fps_from_mol(submol, nbits=fp_nbits)
